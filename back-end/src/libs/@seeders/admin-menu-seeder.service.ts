...
const MASTER_MENUS: MenuSeed[] = [
  ...
  { id: 'a0000001-0000-0000-0000-000000000024', menu_name: 'Marketing Images', route_path: '/admin/marketing-images',       menu_order: 24, menu_icon: 'fa-light fa-image',              sub_menus: [{ name: '', route: '', icon: '' }] },
];
