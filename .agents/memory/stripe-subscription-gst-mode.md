...
description: Why PayTrade keeps Stripe Tax OFF, uses manual TaxRates, and grandfathers exactly one inclusive sub (Signature) via a per-row flag + env-driven backfill.
---
