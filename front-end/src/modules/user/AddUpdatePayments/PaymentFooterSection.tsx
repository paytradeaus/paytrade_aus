...
import { tabTypes, s76ResponseReminderMessage } from "./Payments.constants";
...
export default function PaymentFooterSection() {
  ...
  // s76 BIF Act non-gating reminder — shown once when a user records a less-than-full
