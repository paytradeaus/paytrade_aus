...
//   console.log(
//     "🚀 ~ PlanFeaturesGrid ~ subscriptionPlanTypes:",
//     subscriptionPlanTypes
//   );
...
//                       </th>
//                     )}
//                     <th className="centered">{data?.plan_name}</th>
//                   </Fragment>
//                 ))}
...
//                     paymentPlans().map((data: any, index: number) => (
//                       <Fragment key={index}>
//                         {isCurrentPlan(subscriptionPlanTypes?.free_plan) &&
//                           index === 0 && (
//                             <Fragment>
//                               {isCurrentPlan(
//                                 subscriptionPlanTypes?.free_plan?.plan_items
//                               ) ? (
//                                 <td className="centered largeicon">
//                                   <i className="fa-light fa-check valid"></i>
//                                 </td>
//                               ) : (
//                                 <td className="centered largeicon">
//                                   <i className="fa-light fa-xmark invalid"></i>
//                                 </td>
//                               )}
//                             </Fragment>
//                           )}
