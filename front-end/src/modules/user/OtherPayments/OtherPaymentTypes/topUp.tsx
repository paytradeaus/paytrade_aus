...
const TopUpForm = (props: any) => {
  ...
  useEffect(() => {
    ...
    if (bankIDFrom) {
      try {
        ...
        if (accountList?.data?.account_type === "Project Trust Account") {
          formik.setFieldValue("accountId", bankIDFrom);
          ...
          setSelectedValue(accountList);
          showErrorToast(
            "Top up cannot be added against the Cash or RTA account"
          );
          setAccountError(
            "Top up cannot be added against the Cash or RTA account"
          );
  ...
  const handleSelectChange = (selectedValue: any) => {
    ...
    if (selectedValue?.data?.account_type === "Project Trust Account") {
      setAccountError(null);
    } else {
      // showErrorToast("Top up cannot be added against the Cash or RTA account");
      setAccountError("Top up cannot be added against the Cash or RTA account");
    }
