...
const OverPaymentToSupplierForm = (props: any) => {
  ...
  const handleGetProjectList = async () => {
    try {
      ...
      const payload = {
        companyId: companyId,
        bankAccountId: formik?.values?.accountId
          ? Number(formik?.values?.accountId)
          : null,
        isArchived: false,
      };
      ...
      <div>
        ...
        <div style={{ marginBottom: "0.8rem" }}>
          <SearchableSelect
            ...
            disabled={!!data?.payment_id || !formik?.values?.accountId}
...
export default OverPaymentToSupplierForm;
