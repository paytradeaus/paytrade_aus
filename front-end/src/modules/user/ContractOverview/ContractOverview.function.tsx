...
export const updateContractStatusById = async (
  ...
  try {
    ...
    if (response?.data?.updateContractStatusById?.status === "SUCCESS") {
      showSuccessToast(response?.data?.updateContractStatusById?.message);
      return true;
    }
    if (response?.data?.updateContractStatusById?.status === "ERROR") {
      showErrorToast(response?.data?.updateContractStatusById?.message);
      return false;
    }
    return false;
  } catch (error: any) {
...
export const TriggerContractNotices = async (
  ...
  try {
    ...
    if (response?.data?.triggerContractNotices?.status === "SUCCESS") {
      showSuccessToast(response?.data?.triggerContractNotices?.message);
      return true;
    }
    if (response?.data?.triggerContractNotices?.status === "ERROR") {
      showErrorToast(response?.data?.triggerContractNotices?.message);
      console.error(response?.data);
      return false;
    }
  } catch (error: any) {
