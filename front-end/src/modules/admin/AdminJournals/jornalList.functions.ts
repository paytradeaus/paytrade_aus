...
export const fetchBankAccountsForJournals = async (
  ...
  try {
    ...
    if (
      ...
      showErrorToast(response.data.getAllBankAccountsForJournals.message);
      return null;
    }
  } catch (error: any) {
...
export const fetchFiltersForAdminJournals = async (
  ...
  try {
    ...
    if (response && response.data.getFiltersForAdmin.status === "ERROR") {
      showErrorToast(response.data.getFiltersForAdmin.message);
      return null;
    }
  } catch (error: any) {
...
export const fetchFiltersForAdminTrustAccounting = async (
  ...
  try {
    ...
    if (
      ...
      showErrorToast(response.data.fetchFiltersForAdminTrustAccounting.message);
      return null;
    }
  } catch (error: any) {
