...
export default function BlogList() {
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: ({ id, category, title }: any) => {
        setCookie("blogId", id);
        router.push(
          `${AppRoutes.USER_BLOG_RECOMMENDED}/${slugifyString(
            category
  ...
  const handleOptionClick = async (data: any) => {
    ...
    if (option === EDIT) {
      router.push(`${AppRoutes.ADMIN_BLOG_EDIT}${id}`);
    }
  };
  ...
  async function handleAccept() {
    if (buttonClickFrom?.from == "Delete") {
      ...
      let response = await AdminUpdateBlogResource(
        payload,
        `Blog post has been ${blog_status}.`
      );
      if (response) {
    ...
    <div className="container-fluid">
      <div className="pt_title">
        ...
        <div className="grid pt_topfilters">
          ...
          <div className="pt_pageactions">
            <Link href={"/admin/blog/add"} passHref legacyBehavior>
              <a className="pt_addnewbutton">
                <button className="secondary">
                  <i className="fa-light fa-hexagon-plus"></i>Add blog
                </button>
              </a>
            </Link>
          </div>
      ...
      <div className="pt_filtergroup">
        <div className="grid pt_topfilters align_view_activity">
          <div className="pt_pageactions">
            <GridExportActions
              excelFile={{
                sheetName: "admin blog list",
                tableData: filteredData,
                LabelAndValueKey: excelColumnNames,
              }}
              pdfFile={{
                fileName: "admin blog list",
      ...
      <div className="grid">
        ...
        {modalPublish && (
          ...
          >
            <p>
              Are you sure you wish to {buttonClickFrom?.from} this blog post?
            </p>
          </BaseModal>
        )}
      </div>
