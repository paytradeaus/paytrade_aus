...
export default function AdminResourceGuides() {
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: ({ id, title, category }: any) => {
        setCookie("blogId", id);
        router.push(
          `${AppRoutes.RESOURCE_GUIDES_VIEWS}/${slugifyString(
            category
  ...
  const handleOptionClick = async (data: any) => {
    ...
    if (option === EDIT) {
      router.push(`${AppRoutes.RESOURCE_GUIDES_EDIT}${id}`);
    }
  };
  ...
  async function handleAccept() {
    if (buttonClickFrom?.from == "Delete") {
      ...
      let response = await AdminUpdateBlogResource(
        payload,
        `Resource guide has been ${blog_status}.`
      );
      if (response) {
    ...
    <div className="container-fluid">
      <div className="pt_title">
        ...
        <div className="grid pt_topfilters">
          ...
          <div className="pt_pageactions">
            <Link href={"/admin/resource/add"} passHref legacyBehavior>
              <a className="pt_addnewbutton">
                <button className="secondary">
                  <i className="fa-light fa-hexagon-plus"></i>Add resource guide
                </button>
              </a>
            </Link>
          </div>
      ...
      <div className="pt_filtergroup">
        <div className="grid pt_topfilters align_view_activity">
          <div className="pt_pageactions">
            <GridExportActions
              excelFile={{
                sheetName: "admin resource list",
                tableData: filteredData,
                LabelAndValueKey: excelColumnNames,
              }}
              pdfFile={{
                fileName: "admin resource list",
      ...
      <div className="grid">
        ...
        {modalVisible && (
          ...
          >
            <p>Are you sure you wish to delete this resource guide?</p>
          </BaseModal>
        )}
        {modalPublish && (
          <BaseModal
          ...
          >
            <p>
              Are you sure you wish to {buttonClickFrom?.from} this resource
              guide?
            </p>
          </BaseModal>
        )}
