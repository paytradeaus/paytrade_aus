  ...
  return (
    <main ref={(el: any) => (cardsRef.current = el?.querySelectorAll(".card"))}>
      <TitleSection
        ...
        subtitle="Easy project trust accounting and compliance with PayTrade for Subcontractors"
        description="Subcontractors can check and monitor projects trust eligibility, manage your project and retention trust accounts, process claims and payments, monitor your compliance, submit regulatory notices, automate your trust accounts and reporting and integrate with other apps. See how PayTrade can help you."
      />
