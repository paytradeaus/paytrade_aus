...
export default function AccountantsPage() {
  ...
  return (
    <main ref={(el: any) => (cardsRef.current = el?.querySelectorAll(".card"))}>
      <TitleSection
        title="Accountants"
        subtitle="Easy project trust accounting and compliance with PayTrade for Accountants"
        description="Accountants can check and monitor their clients project trust eligibility, manage their project and retention trust accounts, process claims and payments, monitor their compliance, submit regulatory notices, automate trust accounts and reporting and integrate with other apps. See how Pay Trade can help you support your clients."
      />
