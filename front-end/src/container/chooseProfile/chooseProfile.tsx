...
import { triggerActivityLogWhileSwitchingBusinessProfile } from "./chooseProfile.functions";
...
export const ChooseProfilePage = () => {
  ...
  const handleCancelClick = () => {
    router.push(ApplicationURLS?.USER_DASHBOARD); // Send the user back to the previous page
  };
